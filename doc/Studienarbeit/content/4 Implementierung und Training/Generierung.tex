...
\end{table}
Die Parameter \mintinline{bash}{--motion-blur}, \mintinline{bash}{--make-invalid} und \mintinline{bash}{--snow} können miteinander kombiniert werden. Beispielhafte Aufrufe des Skripts zeigt Listing \ref{lst:generate-cli-examples}.
\begin{samepage}
\begin{code}
   \begin{minted}{bash}
