...
Für diese Studienarbeit existiert ein Ordner \mintinline{python}|data|, der alle für die Arbeit relevanten Bilddateien enhält. Der Ordner ist öffentlich unter \href{https://drive.google.com/drive/folders/11gaUErheUYb0WlBPtWhxgCK7mE0URHYI?usp=sharing}{\textbf{diesem Link}} verfügbar (Stand: 09.06.2023). In dem Unterordner \mintinline{python}{Train} befindet sich dort der gesamte Trainingsdatensatz.
